...
<div class="row layout-top-spacing" id="cancel-row">
                ...
                <div class="widget-header">
                        @if (auth()->user()->role == 'user' && auth()->user()->location_id == '')
                            <span class="badge badge-danger float-right"> You don't have access to create notification. Please contact your Administrator. </span>
                        @elseif(auth()->user()->role == 'user' || auth()->user()->role == 'admin' || auth()->user()->role == 'super_admin')
