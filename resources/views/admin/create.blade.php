                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <form class="mt-0" method="POST" action="{{ route('users.store') }}">
                                             @csrf
                                                    <div class="form-group">
                                                    <input type="text" class="form-control mb-2" name="name"  value="{{ old('name') }}" placeholder="Name" required> 
                                                    @if($errors->has('name'))
                                                    ...
                                                    <div class="form-group">
                                                    <input type="email" class="form-control mb-4" name="email" value="{{ old('email') }}" placeholder="Email">
                                                      @if($errors->has('email'))
                                                    ...
                                                    <div class="form-group">
                                                    <input type="password" class="form-control mb-4" name="password_confirmation" placeholder="Confirm Password" required>
