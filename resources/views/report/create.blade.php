...
<div class="col-lg-12 layout-spacing mt-4">
                            <div class="statbox widget box box-shadow">
                                ...
                                <form class="form-horizontal" method="POST" action="{{ route('reports.store') }}" enctype="multipart/form-data" id="rep-Create">
                                @csrf
                                    ...
                                    <div id="circle-basic" class="">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="mgr_name" class="form-control basic" data-live-search="true" >
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <select name="sup_name" class="form-control basic" data-live-search="true" >
                                                            <option value="">Select</option>
                                            ...
                                            <div class="form-group">
                                                <label for="inc_loc">Place of the Incident/Injury<span class="text-danger"> *</span></label>
                                                            <input type="text" class="form-control" value="{{ old('inc_loc') }}" name="inc_loc" placeholder="Place of the Incident/Injury" >
                                            ...
                                            <label for="other">Specify<span class="text-danger"> *</span></label>
                                                <input value="{{ old('other') }}" name="other" class="form-control" type="text" placeholder="Please specify . . ." >
                                            </div>
                                            </div>
                                            <div class="col-md-12">
                                            <div class="form-group">
                                            <label for="description">Brief Description of the Incident/Injury<span class="text-danger"> *</span></label>
                                                <textarea class="form-control" name="description" placeholder="Write your Brief Description of the Incident/Injury here ..." >{{ old('description') }}</textarea>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="details" placeholder="Write your Details of the Injury here ..." >{{ old('details') }}</textarea>
                                        ...
                                        <section>
                                            ...
                                            <label for="aid">First Aid Given?<span class="text-danger"> *</span></label>
                                                <select name="aid" class="form-control" id="frst_aid" >
                                                                <option value="">Select</option>
                                            ...
                                            <div class="form-group frm-aider-div" id="vidYes" style="display:none">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <label for="hosp">Hospitalized?<span class="text-danger"> *</span></label>
                                                        <select name="hosp" class="form-control" id="frm_hosp" >
                                                                        <option value="">Select</option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="med_leave" class="form-control" id="med_leave" >
                                                                <option value="">Select</option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="prop_dam" class="form-control" id="frm_duration" >
                                                                <option value="">Select</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                    ...
                                                    <select name="toolbox" class="form-control" >
                                                                <option value="">Select</option>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <select name="ppe" class="form-control" id="frm_ppe" >
                                                                <option value="">Select</option>
                                            ...
                                            <div class="form-group">
                                                    <label for="emp_doing">What was the injured person/employee doing at the time of the incident?  <span class="text-danger"> *</span></label>
                                                        <input type="text" class="form-control" value="{{ old('emp_doing') }}" name="emp_doing" placeholder="Enter data here . . ." >
                                            ...
                                            <div class="form-group">
                                                    <label for="emp_machine">What was the machine/equipment doing at the time of the incident?  <span class="text-danger"> *</span></label>
                                                        <input type="text" class="form-control" value="{{ old('emp_machine') }}" name="emp_machine" placeholder="Enter data here . . ." >
                                            ...
                                            <div class="form-group">
                                                    <label for="emp_material">What was the material(s) / substance(s) doing at the time of the incident  <span class="text-danger"> *</span></label>
                                                        <input type="text" class="form-control" value="{{ old('emp_material') }}" name="emp_material" placeholder="Enter data here . . ." >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="imm_cause" placeholder="Write your data here ..." >{{ old('imm_cause') }}</textarea>
